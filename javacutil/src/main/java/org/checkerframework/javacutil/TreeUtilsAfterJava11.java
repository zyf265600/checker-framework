...
public class TreeUtilsAfterJava11 {
        ...
        public static VariableTree getVariable(Tree bindingPatternTree) {
            ...
            if (GET_VARIABLE == null) {
                Class<?> bindingPatternClass =
                        classForName("com.sun.source.tree.BindingPatternTree");
    ...
    public static class CaseUtils {
         ...
         * <expression>}. This method should only be called if {@link CaseTree#getStatements()}
         * returns null.
         *
        ...
        /**
         * Returns true if this is the default case for a switch statement or expression. (Also,
         * returns true if {@code caseTree} is {@code case null, default:}.)
         *
         * @param caseTree a case tree
         ...
         * empty.
         *
         * <p>For 21+ JDK, if {@code useDefaultCaseLabelTree} is false, then if {@code caseTree} is
         * the default case or {@code case null, default}, then the returned list is empty. If
         * {@code useDefaultCaseLabelTree} is true, then if {@code caseTree} is the default case the
         * returned contains just a {@code DefaultCaseLabelTree}. If {@code useDefaultCaseLabelTree}
         * is false, then if {@code caseTree} is {@code case null, default} the returned list is a
         * {@code DefaultCaseLabelTree} and the expression tree for {@code null}.
         *
         * <p>Otherwise, in JDK 11 and earlier, this is a list of a single expression tree. In JDK
         * 12+, the list may have multiple expression trees. In JDK 21+, the list might contain a
         * single pattern tree.
         *
         * @param caseTree the case expression to get the labels from
        ...
        public static List<? extends ExpressionTree> getExpressions(CaseTree caseTree) {
            if (sourceVersionNumber >= 12) {
                ...
                return (List<? extends ExpressionTree>)
                        invokeNonNullResult(GET_EXPRESSIONS, caseTree);
            }
    ...
    public static class ConstantCaseLabelUtils {
        ...
        /**
         * The {@code ConstantCaseLabelTree.getConstantExpression} method for Java 21 and higher;
         * null otherwise.
         */
        ...
        public static ExpressionTree getConstantExpression(Tree constantCaseLabelTree) {
            ...
            if (GET_CONSTANT_EXPRESSION == null) {
                ...
                GET_CONSTANT_EXPRESSION =
                        getMethod(constantCaseLabelTreeClass, "getConstantExpression");
            }
            return (ExpressionTree)
                    invokeNonNullResult(GET_CONSTANT_EXPRESSION, constantCaseLabelTree);
        }
    }
    ...
    public static class DeconstructionPatternUtils {
        ...
        /**
         * The {@code DeconstructionPatternTree.getDeconstructor} method for Java 21 and higher;
         * null otherwise.
         */
        private static @Nullable Method GET_DECONSTRUCTOR = null;

        /**
         * The {@code DeconstructionPatternTree.getNestedPatterns} method for Java 21 and higher;
         * null otherwise.
         */
    ...
    public static class PatternCaseLabelUtils {
        ...
        public static Tree getPattern(Tree patternCaseLabelTree) {
            assertVersionAtLeast(21);
            if (GET_PATTERN == null) {
                Class<?> patternCaseLabelClass =
                        classForName("com.sun.source.tree.PatternCaseLabelTree");
    ...
    public static class SwitchExpressionUtils {
        ...
        /**
         * The {@code SwitchExpressionTree.getExpression} method for Java 12 and higher; null
         * otherwise.
         */
        ...
        public static List<? extends CaseTree> getCases(Tree switchExpressionTree) {
            ...
            if (GET_CASES == null) {
                Class<?> switchExpressionClass =
                        classForName("com.sun.source.tree.SwitchExpressionTree");
    ...
    public static class InstanceOfUtils {
        ...
        /**
         * Returns the pattern of {@code instanceOfTree} tree. Returns null if the instanceof does
         * not have a pattern, including if the JDK version does not support instance-of patterns.
         *
    ...
    /**
     * Reflectively invokes {@code method} with {@code receiver}; rethrowing any exceptions as
     * {@code BugInCF} exceptions. If the results is {@code null} a {@code BugInCF} is thrown.
     *
    ...
    /**
     * Returns the {@link Method} object for the method with name {@code name} in class {@code
     * clazz}. Rethrowing any exceptions as {@code BugInCF} exceptions.
     *
     * @param clazz a class
     * @param name a method name
     * @return the {@link Method} object for the method with name {@code name} in class {@code
     *     clazz}
     */
