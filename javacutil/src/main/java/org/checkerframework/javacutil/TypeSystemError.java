 ...
 *
 * <p>To indicate a bug in the framework, use {@link BugInCF}. To indicate that an end user (a
 * programmer running a type-checker) made a mistake, use {@link UserError}.
 */
