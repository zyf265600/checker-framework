...
public class BugInCF extends RuntimeException {
    ...
    /**
     * Adds the location to {@code throwable}. If {@code throwable} is a {@code BugInCF} that does
     * not have a location, then its location is set to {@code location}.
     *
     * <p>If {@code throwable} is not a{@code BugInCF}, then a {@code BugInCF} is created with
     * {@code location} and cause {@code throwable}.
     *
