...
public interface AnnotationProvider {
    ...
    /**
     * Returns true if the given method is deterministic according to this AnnotationProvider
     * &mdash; that is, if multiple calls to the given method (with the same arguments) return the
     * same value.
     *
     * <p>Note that this method takes account of this AnnotationProvider's semantics, whereas {@code
