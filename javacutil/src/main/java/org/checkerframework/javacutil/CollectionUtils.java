...
public class CollectionUtils {
    ...
    /**
     * Returns a copy of {@code orig}, where each value of the result is a clone of the
     ...
     * (according to the {@code DeepCopyable} interface) of the corresponding element of {@code
     * orig}.
     *
     * @param <K> the type of keys of the map
     * @param <V> the type of values of the map
    ...
    /**
     * Returns a copy of {@code orig}, where each value of the result is a deep copy (according to
     * the {@code DeepCopyable} interface) of the corresponding value of {@code orig}, but the keys
