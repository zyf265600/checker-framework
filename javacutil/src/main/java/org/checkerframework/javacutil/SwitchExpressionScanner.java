...
public abstract class SwitchExpressionScanner<R, P> extends TreeScanner<R, P> {
    ...
    /**
     * Scans the given switch expression and calls {@link
     * #visitSwitchResultExpression(ExpressionTree, Object)} on each result expression of the switch
     * expression. {@link #combineResults(Object, Object)} is called to combine the results of
     * visiting multiple switch result expressions.
     *
     * @param switchExpression a switch expression tree
     * @param p the parameter to pass to {@link #visitSwitchResultExpression(ExpressionTree,
     *     Object)}
    ...
    public static class FunctionalSwitchExpressionScanner<R1, P1>
         ...
         * @param combineResultFunc the function used to combine the result of multiple calls to
         *     {@code switchValueExpressionFunc}
         */
