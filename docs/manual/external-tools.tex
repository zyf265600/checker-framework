...
other than \<\${HOME}/checker-framework-3.34.0-eisop1/>.
...
\begin{itemize}
  \item
    Option 1:
    Add directory
    \code{.../checker-framework-3.34.0-eisop1/checker/bin} to your path, \emph{before} any other
...
\item \<checker-qual.jar>: \url{https://repo1.maven.org/maven2/io/github/eisop/checker-qual/3.34.0-eisop1/checker-qual-3.34.0-eisop1.jar}
\item \<checker-util.jar>: \url{https://repo1.maven.org/maven2/io/github/eisop/checker-util/3.34.0-eisop1/checker-util-3.34.0-eisop1.jar}
\item \<checker.jar>: \url{https://repo1.maven.org/maven2/io/github/eisop/checker/3.34.0-eisop1/checker-3.34.0-eisop1-all.jar}
\end{itemize}
...
versions of Java: JDK 11, JDK 17, and JDK 20.
