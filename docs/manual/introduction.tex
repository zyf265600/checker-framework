...
\item
  ...
  \\
  %END LATEX
  \url{https://eisop.github.io/cf/checker-framework-3.49.3-eisop1.zip}
...
There is also a \ahreforurl{https://eisop.github.io/cf/tutorial/}{tutorial}
...
There is a
\ahreforurl{https://eisop.github.io/cf/tutorial/}{tutorial}
...
\item \<-AonlyAnnotatedFor>
  Suppress all errors and warnings for code outside the scope of a corresponding \<@AnnotatedFor> and
  unsoundly use source defaults.
  See Section~\ref{aonlyannotatedfor}.
...
% LocalWords:  AexceptionLineSeparator
