...
%%  LocalWords:  getTypeFactoryOfSubchecker checkername inference''
...
% LocalWords:  representation'' stubfilename commonAssignmentCheck
% LocalWords:  AshowWpiFailedInferences CheckerMain wrapper'' typechecker
% LocalWords:  AatfDoNotCache AatfCacheSize PolyPresent Subinterface
% LocalWords:  UnionType
