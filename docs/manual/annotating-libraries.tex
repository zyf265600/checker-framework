...
\item
  ...
  % (\myurl{https://eisop.github.io/afu/}).
...
%     typing those 17 characters later.
  ...
  \item
    ...
    \href{https://htmlpreview.github.io/?https://github.com/eisop/checker-framework/master/docs/developer/developer-manual.html#annotated-library-version-numbers}{corresponding
...
\item
  ...
  \item
    ...
    \url{https://github.com/eisop/} and upload a compiled artifact to
...
\href{https://eisop.github.io/afu/#insert-annotations-to-source}{\code{insert-annotations-to-source}
  script} from the
\href{https://eisop.github.io/afu/}{Annotation
