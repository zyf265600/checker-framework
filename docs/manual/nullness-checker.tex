...
To suppress warnings by the Nullness Checker without also suppressing warnings
by the Initialization Checker (see Section~\ref{initialization-checker}),
use the \<@SuppressWarnings("nullnessnoinit")> annotation.
