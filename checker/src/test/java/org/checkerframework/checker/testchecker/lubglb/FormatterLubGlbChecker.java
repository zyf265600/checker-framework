...
public class FormatterLubGlbChecker extends FormatterChecker {
    ...
    private void glbAssert(
        ...
        if (!AnnotationUtils.areSame(expected, result)) {
            throw new AssertionError(
                    String.format(
                            "GLB of %s and %s should be %s, but is %s",
    ...
    private void lubAssert(
        ...
        if (!AnnotationUtils.areSame(expected, result)) {
            throw new AssertionError(
                    String.format(
                            "LUB of %s and %s should be %s, but is %s",
                            arg1, arg2, expected, result));
        }
    }
    ...
    public void initChecker() {
        ...
        lubAssert(
                invalidFormatWithMessage, invalidFormatWithMessage2, invalidFormatWithMessagesOred);
