...
public class OptionalImplAnnotatedTypeFactory extends BaseAnnotatedTypeFactory {
     ...
     *
     * @param checker the {@link org.checkerframework.checker.optional.OptionalImplChecker}
     *     associated with this type factory
     */
     ...
     * method reference m, then this method adds {@code @Present} to {@code type} if the following
     * is true:
     *
     * <ul>
     *   <li>The type of the receiver to {@link java.util.Optional#map(Function)} is
     *       {@code @Present}, and
    ...
    private boolean isReturnTypeNullable(MemberReferenceTree memberReferenceTree) {
        ...
        if (memberReferenceFuncType.getEnclosingElement().getKind()
