    ...
    public boolean isReady(StringBuilder message) {
        ...
        for (int i = 0; i < inputVariables.size(); ++i) {
            ...
            if (inputVariable == null) {
                message.append(
                        String.format("- Engine has a null input variable at index <%d>\n", i));
        ...
        for (int i = 0; i < outputVariables.size(); ++i) {
            ...
            if (outputVariable == null) {
                message.append(
                        String.format("- Engine has a null output variable at index <%d>\n", i));
            } else {
        ...
        for (int i = 0; i < ruleBlocks.size(); ++i) {
            ...
            if (ruleBlock == null) {
                ...
                if (ruleBlock.getRules().isEmpty()) {
                    message.append(
                            String.format("- Rule block <%s> has no rules\n", ruleBlock.getName()));
                }
                ...
                if (requiresConjunction > 0 && ruleBlock.getConjunction() == null) {
                    ...
                    message.append(
                            String.format(
                                    "- Rule block <%s> has %d rules that require "
                                            + "Conjunction\n",
