...
public class InferenceResult {
    ...
    /**
     * Convert the instantiated variables to a map from expression tree to a map from type variable
     * to its type argument.
     *
     * @param variables instantiated variables
     ...
     * TypesUtils#areSame(TypeVariable, TypeVariable)} is used to decide which type variables to
     * swap.
     *
