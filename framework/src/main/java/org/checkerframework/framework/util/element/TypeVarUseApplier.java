...
public class TypeVarUseApplier {
     ...
     * be stored with different annotation positions. getPrimaryAnnotations finds the correct
     * annotations by annotation position and element kind and returns them
     */
