...
public class Expression extends TypeConstraint {
    ...
    public ReductionResult reduce(Java8InferenceContext context) {
        ...
        switch (expression.getKind()) {
            ...
            case CONDITIONAL_EXPRESSION:
                ...
                TypeConstraint trueConstraint =
                        new Expression(this, conditional.getTrueExpression(), T);
                Constraint falseConstraint =
                        new Expression(this, conditional.getFalseExpression(), T);
    ...
    private ReductionResult reduceMethodRef(Java8InferenceContext context) {
        ...
        if (TreeUtils.isExactMethodReference(memRef)) {
            ...
            if (ps.size() == fs.size() + 1) {
                ...
                constraintSet.add(
                        new Typing(
                                this, targetReference, referenceType, TypeConstraint.Kind.SUBTYPE));
            }
     ...
     * process might create additional bounds, if so the second in the returned pair will be
     * non-null.
     *
     ...
     * part of a larger inference problem. See 18.5.3: Functional Interface Parameterization
     * Inference
     *
