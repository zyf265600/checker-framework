...
public interface OptionConfiguration {
    ...
    /**
     * Determines the string list value of the option with the given name. The option's value is
     * split on the given separator. Returns an empty list if the option is not set.
     *
     * @param name the name of the option to check
    ...
    /**
     * Determines the string list value of the option with the given name. The option's value is
     * split on the given separator. Returns the given default value if the option is not set.
     *
     * @param name the name of the option to check
     * @param separator the separator for list elements
     * @param defaultValue the default value to use if the option is not set
