...
public class FieldInvariants {
     ...
     * the same length as {@link #qualifiers}.
     */
     ...
     * is either 1 or equal to length of {@code fields}.
     *
     ...
     * fields} and {@code qualifiers}. The result is well-formed if the length of qualifiers is
