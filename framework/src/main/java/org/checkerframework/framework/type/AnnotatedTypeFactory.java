    ...
    */
        ...
        */
        ...
        if (root != null && checker.hasOption("ajava")) {
            ...
            if (candidateAjavaFiles.size() == 1) {
                ...
                String ajavaPath =
                        candidateAjavaFiles.toArray(new String[candidateAjavaFiles.size()])[0];
                try {
        ...
        if (!typeParamToTypeArg.isEmpty()) {
            typeParamToTypeArg =
                    captureMethodTypeArgs(
                            typeParamToTypeArg, memberTypeWithOverrides.getTypeVariables());
    ...
    public ParameterizedExecutableType constructorFromUse(NewClassTree tree) {
        ...
        if (tree.getClassBody() != null) {
            ...
            con.getReturnType()
                    .replaceAnnotations(superCon.getReturnType().getPrimaryAnnotations());
        } else {
    ...
    private AnnotatedPrimitiveType getWidenedPrimitive(
        ...
        result.addAnnotations(
                getWidenedAnnotations(
                        type.getPrimaryAnnotations(), type.getKind(), result.getKind()));
        return result;
    }
    ...
    public AnnotatedWildcardType getUninferredWildcardType(AnnotatedTypeVariable typeVar) {
        ...
        if (!intersectionType) {
            ...
            wctype.getExtendsBound()
                    .addAnnotations(typeVar.getUpperBound().getPrimaryAnnotations());
        }
                ...
                if (wildcardType.isUninferredTypeArgument()) {
                    ...
                    if (types.isSameType(wildcardUbType, correctArgType)) {
                        ...
                        newArgAsTypeVar
                                .getUpperBound()
                                .replaceAnnotations(
                                        wildcardType.getExtendsBound().getPrimaryAnnotations());
                        newArgAsTypeVar
                                .getLowerBound()
                                .replaceAnnotations(
                                        wildcardType.getSuperBound().getPrimaryAnnotations());
                    } else {
                        newArg = this.toAnnotatedType(correctArgType, false);
