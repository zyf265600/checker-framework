...
public abstract class TreeAnnotator extends SimpleTreeVisitor<Void, AnnotatedTypeMirror> {
     ...
     *   <li>This method ({@code TreeAnnotator.visitBinary}) should annotate binary trees with top
     *       so that the type applied in the transfer is always a subtype of the type the
