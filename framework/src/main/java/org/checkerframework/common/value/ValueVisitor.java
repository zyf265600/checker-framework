...
public class ValueVisitor extends BaseTypeVisitor<ValueAnnotatedTypeFactory> {
     ...
     * length.
     *
     * <p>Issues a warning if any {@literal @}MatchesRegex or {@literal @}DoesNotMatchRegex
    ...
    // returns true for (@IntVal(-1), @IntVal(255)) if the underlying type is `byte`, but not for
    // any
