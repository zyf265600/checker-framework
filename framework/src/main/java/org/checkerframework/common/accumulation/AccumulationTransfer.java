...
public class AccumulationTransfer
     ...
     * newly-accumulated values in {@code values}. If dataflow has already recorded information
     * about the target, this method fetches it and integrates it into the list of values in the new
     * annotation.
     *
     * @param store a store
     * @param target an insertable JavaExpression ({@code canInsertJavaExpression(target)} should
     *     have returned true)
