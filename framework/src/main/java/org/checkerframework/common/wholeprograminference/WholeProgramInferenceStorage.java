...
public interface WholeProgramInferenceStorage<T> {
     ...
     * annotations.
     *
     * <p>The {@code update*} methods in {@link WholeProgramInference} perform LUB. This one just
     * does replacement. (Thus, the naming may be a bit confusing.)
     *
    ...
    /**
     * Performs any preparation required for inference on the elements of a class. Should be called
     * on each top-level class declaration in a compilation unit before processing it.
     *
