...
public interface WholeProgramInference {
     ...
     * annotation on {@code elt} with the logical least upper bound between that purity annotation
     * and {@code anno}, if {@code anno} is also a purity annotation.
     *
